...
// New instantiates HTTP handlers for all the goa_starter service endpoints
...
func (s *Server) Service() string { return "goa_starter" }
...
// the "goa_starter" service "add" endpoint.
func NewAddHandler(
