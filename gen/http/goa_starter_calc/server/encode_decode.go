...
//
// goa_starter-calc HTTP server encoders and decoders
//
// Command:
...
// DecodeAddRequest returns a decoder for requests sent to the goa_starter-calc
// add endpoint.
